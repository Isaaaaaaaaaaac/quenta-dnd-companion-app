...
const ADVENTURING_GEAR: SrdGearItem[] = [
  { key: 'abacus',             name: 'Pallottoliere',                category: 'attrezzatura',  weight: 1,    cost: '2 PO',   note: 'Strumento di calcolo a sferette scorrevoli, usato da mercanti e studiosi' },
  ...
  { key: 'blanket',            name: 'Coperta',                       category: 'attrezzatura',  weight: 1.5,  cost: '5 PA',   note: 'Coperta di lana per proteggersi dal freddo durante i viaggi' },
  ...
  { key: 'book',               name: 'Libro',                         category: 'attrezzatura',  weight: 2.5,  cost: '25 PO',  note: 'Volume rilegato; può trattare qualsiasi argomento, da racconti a trattati' },
  ...
  { key: 'chalk',              name: 'Gessetto',                      category: 'attrezzatura',  weight: 0,    cost: '1 PR',   note: 'Pezzo di gesso per scrivere o segnare superfici' },
  ...
  { key: 'fishing_tackle',     name: 'Attrezzatura da Pesca',         category: 'attrezzatura',  weight: 2,    cost: '1 PO',   note: 'Lenza, ami, galleggianti e altri attrezzi per pescare' },
  { key: 'grappling_hook',     name: 'Rampino',                       category: 'attrezzatura',  weight: 2,    cost: '2 PO',   note: 'Gancio a più punte da legare a una corda, per scalare o agganciare oggetti' },
  { key: 'hammer',             name: 'Martello',                      category: 'attrezzatura',  weight: 1.5,  cost: '1 PO',   note: 'Martello comune da lavoro, utile per piantare chiodi o picchetti' },
  { key: 'hammer_sledge',      name: 'Mazza del Fabbro',              category: 'attrezzatura',  weight: 5,    cost: '2 PO',   note: 'Pesante martello a due mani usato per lavori di fucina o demolizione' },
  ...
  { key: 'hourglass',          name: 'Clessidra',                     category: 'attrezzatura',  weight: 0.5,  cost: '25 PO',  note: 'Misura il tempo trascorso tramite il flusso di sabbia tra due ampolle' },
  ...
  { key: 'ink',                name: 'Inchiostro (30 ml)',            category: 'attrezzatura',  weight: 0,    cost: '10 PO',  note: 'Boccetta di inchiostro per scrivere con una penna' },
  { key: 'ink_pen',            name: 'Penna da Inchiostro',           category: 'attrezzatura',  weight: 0,    cost: '2 PR',   note: 'Penna d\'oca o metallica per scrivere con l\'inchiostro' },
  { key: 'ladder_10ft',        name: 'Scala (3 m)',                   category: 'attrezzatura',  weight: 11,   cost: '1 PA',   note: 'Scala portatile in legno, lunga 3 metri' },
  ...
  { key: 'mirror_steel',       name: 'Specchio d\'Acciaio',           category: 'attrezzatura',  weight: 0.25, cost: '5 PO',   note: 'Piccolo specchio levigato, utile per segnalare o osservare dietro un angolo' },
  ...
  { key: 'paper',              name: 'Foglio di Carta',               category: 'attrezzatura',  weight: 0,    cost: '2 PA',   note: 'Un singolo foglio di carta' },
  { key: 'parchment',          name: 'Foglio di Pergamena',           category: 'attrezzatura',  weight: 0,    cost: '1 PA',   note: 'Foglio di pergamena conciata, usato per scrivere documenti o mappe' },
  { key: 'perfume',            name: 'Profumo (fiala)',                category: 'attrezzatura',  weight: 0,    cost: '5 PO',   note: 'Fiala di essenza profumata' },
  { key: 'miners_pick',        name: 'Piccone del Minatore',          category: 'attrezzatura',  weight: 5,    cost: '2 PO',   note: 'Piccone a due punte per scavare roccia e minerali' },
  { key: 'piton',              name: 'Chiodo da Roccia',              category: 'attrezzatura',  weight: 0.1,  cost: '5 PR',   note: 'Chiodo metallico da piantare nella roccia per fissare una corda durante la scalata' },
  ...
  { key: 'pole_10ft',          name: 'Palo (3 m)',                    category: 'attrezzatura',  weight: 3.5,  cost: '5 PR',   note: 'Asta di legno lunga 3 metri, utile per sondare il terreno davanti a sé' },
  { key: 'mess_kit',           name: 'Kit da Campo',                  category: 'attrezzatura',  weight: 0.5,  cost: '2 PA',   note: 'Pentolino e posate semplici per cucinare e mangiare in viaggio' },
  ...
  { key: 'rope_hempen',        name: 'Corda di Canapa (15 m)',        category: 'attrezzatura',  weight: 4.5,  cost: '1 PO',   note: '2 PF; CD 17 Forza per romperla' },
  { key: 'rope_silk',          name: 'Corda di Seta (15 m)',          category: 'attrezzatura',  weight: 2.5,  cost: '10 PO',  note: '2 PF; CD 17 Forza per romperla' },
  { key: 'scale_merchant',     name: 'Bilancia da Mercante',          category: 'attrezzatura',  weight: 1.5,  cost: '5 PO',   note: 'Pesa piccole quantità di merce, in particolare metalli e gemme preziose' },
  { key: 'sealing_wax',        name: 'Ceralacca',                     category: 'attrezzatura',  weight: 0,    cost: '5 PA',   note: 'Cera che si scioglie a fuoco e si solidifica per sigillare lettere e documenti' },
  { key: 'shovel',             name: 'Pala',                          category: 'attrezzatura',  weight: 2.5,  cost: '2 PO',   note: 'Pala da scavo per terra o neve' },
  { key: 'signal_whistle',     name: 'Fischietto Segnaletico',        category: 'attrezzatura',  weight: 0,    cost: '5 PR',   note: 'Fischietto usato per dare segnali a distanza' },
  { key: 'signet_ring',        name: 'Anello con Sigillo',            category: 'attrezzatura',  weight: 0,    cost: '5 PO',   note: 'Anello incise con uno stemma, usato per sigillare documenti con la ceralacca' },
  { key: 'soap',               name: 'Sapone',                        category: 'attrezzatura',  weight: 0,    cost: '2 PR',   note: 'Un pezzo di sapone per lavarsi' },
  ...
  { key: 'spike_iron',         name: 'Chiodo di Ferro',               category: 'attrezzatura',  weight: 0.25, cost: '1 PR',   note: 'Chiodo di ferro per fissare oggetti o bloccare porte' },
  { key: 'spyglass',           name: 'Cannocchiale',                  category: 'attrezzatura',  weight: 0.5,  cost: '1.000 PO', note: 'Raddoppia la portata visiva' },
  { key: 'tent_two_person',    name: 'Tenda (2 persone)',             category: 'attrezzatura',  weight: 10,   cost: '2 PO',   note: 'Tenda di tela in grado di ospitare due persone' },
  ...
  { key: 'whetstone',          name: 'Pietra Affilacoltelli',         category: 'attrezzatura',  weight: 0.5,  cost: '1 PR',   note: 'Pietra abrasiva per affilare lame' },
  { key: 'bedroll',            name: 'Sacco a Pelo',                  category: 'attrezzatura',  weight: 3.5,  cost: '1 PO',   note: 'Imbottitura arrotolabile per dormire al riparo dal freddo del terreno' },
  { key: 'bell',               name: 'Campanellino',                  category: 'attrezzatura',  weight: 0,    cost: '1 PO',   note: 'Piccola campana che produce un suono chiaro quando agitata' },
];
...
const CLOTHING: SrdGearItem[] = [
  { key: 'clothes_common',      name: 'Abiti Comuni',                 category: 'abbigliamento', weight: 1.5,  cost: '5 PA',  note: 'Vestiti semplici e funzionali, adatti alla vita di tutti i giorni' },
  { key: 'clothes_costume',     name: 'Abiti da Costume',             category: 'abbigliamento', weight: 2,    cost: '5 PO',  note: 'Costume teatrale o cerimoniale, utile per travestimenti e spettacoli' },
  { key: 'clothes_fine',        name: 'Abiti Eleganti',               category: 'abbigliamento', weight: 3,    cost: '15 PO', note: 'Abiti raffinati adatti a corti, banchetti e occasioni di prestigio' },
  { key: 'clothes_traveler',    name: 'Abiti da Viaggio',             category: 'abbigliamento', weight: 2,    cost: '2 PO',  note: 'Vestiti robusti pensati per resistere a lunghi spostamenti' },
  { key: 'robes',               name: 'Veste/Abito Talare',           category: 'abbigliamento', weight: 2,    cost: '1 PO',  note: 'Ampia veste indossata da sacerdoti, maghi e studiosi' },
];
...
const MUNDANE_AMMO: SrdGearItem[] = [
  { key: 'arrows_20',           name: 'Frecce (20)',                   category: 'munizioni_mundane', weight: 0.5, cost: '1 PO',  note: 'Faretra di 20 frecce per arco corto o lungo' },
  { key: 'bolts_20',            name: 'Quadrelli per Balestra (20)',   category: 'munizioni_mundane', weight: 0.75, cost: '1 PO', note: 'Confezione di 20 quadrelli per balestra' },
  { key: 'bullets_20',          name: 'Proiettili per Fionda (20)',    category: 'munizioni_mundane', weight: 0.75, cost: '4 PR', note: 'Confezione di 20 proiettili di piombo o pietra per fionda' },
  { key: 'needles_50',          name: 'Aghi per Cerbottana (50)',      category: 'munizioni_mundane', weight: 0.5, cost: '1 PO',  note: 'Confezione di 50 aghi per cerbottana' },
];
...
const INSTRUMENTS: SrdGearItem[] = [
  { key: 'bagpipes',            name: 'Cornamusa',                     category: 'strumento_musicale', weight: 3,  cost: '30 PO',  note: 'Strumento a fiato con sacca d\'aria e canne, tipico delle tradizioni popolari' },
  { key: 'drum',                name: 'Tamburo',                       category: 'strumento_musicale', weight: 1.5, cost: '6 PO',  note: 'Strumento a percussione a membrana tesa' },
  { key: 'dulcimer',            name: 'Salterio',                      category: 'strumento_musicale', weight: 5,  cost: '25 PO',  note: 'Strumento a corde percosse con piccoli martelletti' },
  { key: 'flute',               name: 'Flauto',                        category: 'strumento_musicale', weight: 0.5, cost: '2 PO',  note: 'Strumento a fiato in legno o metallo' },
  { key: 'hand_drum',           name: 'Tamburello',                    category: 'strumento_musicale', weight: 0.5, cost: '6 PO',  note: 'Piccolo tamburo a mano, spesso con sonagli' },
  { key: 'horn',                name: 'Corno',                         category: 'strumento_musicale', weight: 1,  cost: '3 PO',   note: 'Strumento a fiato ricavato da un corno animale o lavorato in metallo' },
  { key: 'lute',                name: 'Liuto',                         category: 'strumento_musicale', weight: 1,  cost: '35 PO',  note: 'Strumento a corde pizzicate con cassa a forma di pera' },
  { key: 'lyre',                name: 'Lira',                          category: 'strumento_musicale', weight: 1,  cost: '30 PO',  note: 'Antico strumento a corde pizzicate a forma di U' },
  { key: 'pan_flute',           name: 'Flauto di Pan',                 category: 'strumento_musicale', weight: 1,  cost: '12 PO',  note: 'Strumento a fiato composto da più canne di lunghezza diversa' },
  { key: 'shawm',               name: 'Scalmeia',                      category: 'strumento_musicale', weight: 0.5, cost: '2 PO',  note: 'Antico strumento a fiato dal suono penetrante, antenato dell\'oboe' },
  { key: 'viol',                name: 'Viola',                         category: 'strumento_musicale', weight: 0.5, cost: '30 PO', note: 'Strumento a corde suonato con un archetto' },
];
...
const TACK_HARNESS: SrdGearItem[] = [
  ...
  { key: 'bit_bridle',          name: 'Morso e Briglie',                category: 'bardatura',   weight: 0.25, cost: '2 PO',   note: 'Imboccatura e cinghie per guidare una cavalcatura' },
  ...
  { key: 'saddle_pack',         name: 'Sella da Soma',                  category: 'bardatura',   weight: 7.5,  cost: '5 PO',   note: 'Sella pensata per il trasporto di carichi piuttosto che per cavalcare' },
  { key: 'saddle_riding',       name: 'Sella da Equitazione',           category: 'bardatura',   weight: 11,   cost: '10 PO',  note: 'Sella standard per cavalcare comodamente' },
  { key: 'saddlebags',          name: 'Bisacce',                        category: 'bardatura',   weight: 4,    cost: '4 PO',   note: 'Capacità: 15 kg / lato' },
  { key: 'stabling_day',        name: 'Stalla (per giorno)',            category: 'bardatura',   weight: 0,    cost: '5 PA',   note: 'Affitto di una stalla per il riposo di una cavalcatura per un giorno' },
  { key: 'feed_day',            name: 'Foraggio (per giorno)',          category: 'bardatura',   weight: 5,    cost: '5 PR',   note: 'Razione di foraggio per nutrire una cavalcatura per un giorno' },
];
...
const FOOD_DRINK: SrdGearItem[] = [
  ...
  { key: 'bread_loaf',          name: 'Pane (pagnotta)',               category: 'consumabile',   weight: 0.5,  cost: '2 PR',   note: 'Una pagnotta di pane fresco' },
  { key: 'cheese_hunk',         name: 'Formaggio (pezzo)',             category: 'consumabile',   weight: 0.25, cost: '1 PA',   note: 'Un pezzo di formaggio stagionato' },
  { key: 'meat_chunk',          name: 'Carne (porzione)',              category: 'consumabile',   weight: 0.5,  cost: '3 PA',   note: 'Una porzione di carne, fresca o conservata' },
  { key: 'chicken_whole',       name: 'Pollo Intero',                  category: 'consumabile',   weight: 1,    cost: '2 PA',   note: 'Un pollo intero, crudo o cucinato' },
  // Bevande
  { key: 'ale_gallon',          name: 'Birra (gallone)',               category: 'consumabile',   weight: 4,    cost: '2 PA',   note: 'Una damigiana di birra, circa 4,5 litri' },
  { key: 'ale_mug',             name: 'Birra (boccale)',               category: 'consumabile',   weight: 0.5,  cost: '4 PR',   note: 'Un boccale di birra' },
  { key: 'cider_gallon',        name: 'Sidro (gallone)',               category: 'consumabile',   weight: 4,    cost: '2 PA',   note: 'Una damigiana di sidro, circa 4,5 litri' },
  { key: 'wine_common',         name: 'Vino Comune (brocca)',          category: 'consumabile',   weight: 2,    cost: '2 PA',   note: 'Una brocca di vino di qualità modesta' },
  { key: 'wine_fine',           name: 'Vino Pregiato (bottiglia)',     category: 'consumabile',   weight: 1,    cost: '10 PO',  note: 'Una bottiglia di vino di alta qualità' },
  { key: 'banquet_person',      name: 'Banchetto (a persona)',         category: 'consumabile',   weight: 0,    cost: '10 PO',  note: 'Pasto sontuoso per una persona, adatto a celebrazioni e cerimonie' },
...
const TRADE_GOODS: SrdGearItem[] = [
  { key: 'goods_wheat',         name: 'Grano (0,5 kg)',               category: 'merce',         weight: 0.5,  cost: '1 PR',  note: 'Materia prima per la panificazione' },
  { key: 'goods_flour',         name: 'Farina (0,5 kg)',              category: 'merce',         weight: 0.5,  cost: '2 PR',  note: 'Farina macinata' },
  { key: 'goods_salt',          name: 'Sale (0,5 kg)',                category: 'merce',         weight: 0.5,  cost: '5 PR',  note: 'Merce preziosa per la conservazione del cibo' },
  { key: 'goods_iron',          name: 'Ferro (0,5 kg)',               category: 'merce',         weight: 0.5,  cost: '1 PA',  note: 'Ferro grezzo o lavorato' },
  { key: 'goods_canvas',        name: 'Tela (0,09 m²)',               category: 'merce',         weight: 0.25, cost: '1 PA',  note: 'Tela grezza, usata per vele, tende e sacchi' },
  { key: 'goods_cotton',        name: 'Cotone (0,09 m²)',             category: 'merce',         weight: 0.25, cost: '5 PA',  note: 'Stoffa di cotone' },
  { key: 'goods_ginger',        name: 'Zenzero (0,5 kg)',             category: 'merce',         weight: 0.5,  cost: '1 PO',  note: 'Radice di zenzero, spezia pregiata' },
  { key: 'goods_cinnamon',      name: 'Cannella (0,5 kg)',            category: 'merce',         weight: 0.5,  cost: '2 PO',  note: 'Spezia aromatica di valore' },
  { key: 'goods_pepper',        name: 'Pepe (0,5 kg)',                category: 'merce',         weight: 0.5,  cost: '2 PO',  note: 'Una delle spezie più richieste nel commercio' },
  { key: 'goods_cloves',        name: 'Chiodi di Garofano (0,5 kg)', category: 'merce',         weight: 0.5,  cost: '3 PO',  note: 'Spezia rara e costosa' },
  { key: 'goods_saffron',       name: 'Zafferano (0,5 kg)',           category: 'merce',         weight: 0.5,  cost: '15 PO', note: 'Una delle spezie più rare e preziose' },
  { key: 'goods_silk',          name: 'Seta (0,09 m²)',               category: 'merce',         weight: 0.1,  cost: '10 PO', note: 'Stoffa di seta, materiale di lusso' },
  { key: 'goods_silver',        name: 'Argento (0,5 kg)',             category: 'merce',         weight: 0.5,  cost: '5 PO',  note: 'Argento grezzo' },
  { key: 'goods_porcelain',     name: 'Porcellana (0,5 kg)',          category: 'merce',         weight: 0.5,  cost: '5 PO',  note: 'Porcellana finemente lavorata' },
  { key: 'goods_glass',         name: 'Vetro (0,5 kg)',               category: 'merce',         weight: 0.5,  cost: '5 PO',  note: 'Vetro lavorato o grezzo' },
  { key: 'goods_fur',           name: 'Pelliccia pregiata',           category: 'merce',         weight: 0.5,  cost: '5 PO',  note: 'Pelliccia di animale pregiato, ricercata dai mercanti di tessuti' },
  { key: 'goods_ivory',         name: 'Avorio (0,5 kg)',              category: 'merce',         weight: 0.5,  cost: '10 PO', note: 'Materiale raro usato per intagli e ornamenti' },
  { key: 'goods_gold',          name: 'Oro (0,5 kg)',                 category: 'merce',         weight: 0.5,  cost: '50 PO', note: 'Oro grezzo' },
  { key: 'goods_platinum',      name: 'Platino (0,5 kg)',             category: 'merce',         weight: 0.5,  cost: '500 PO', note: 'Tra i metalli più preziosi' },
];
