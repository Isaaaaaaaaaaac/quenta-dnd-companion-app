  ...
  return (
    <div style={{ maxWidth: 860, margin: '0 auto', padding: '40px 24px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 48 }}>
        ...
        <a href="/characters/new" className="btn btn-secondary">+ Nuovo</a>
      </div>
      ...
      {all.length === 0 && (
        <div style={{ textAlign: 'center', padding: '80px 0' }}>
          ...
          <a href="/characters/new" className="btn btn-primary">Crea il primo</a>
        </div>
      )}
      ...
      <div className="card" style={{ padding: 24, position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 16 }}>
          ...
          <div style={{
            ...
            {sheet.portraitUrl ? (
              ...
              <span style={{ color: 'var(--fg-3)', fontSize: '1.1rem' }}>⚔</span>
            )}
          </div>
        </div>

        {/* Race / background */}
        {(sheet.race || sheet.background) && (
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 12 }}>
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontFamily: 'var(--font-body)', fontSize: '1.4rem', fontWeight: 700, color: hpFillColor, lineHeight: 1 }}>
              {character.hpCurrent}
            </div>
            <div style={{ fontFamily: 'var(--font-label)', fontSize: '7px', color: 'var(--fg-3)', letterSpacing: '0.2em' }}>
              /{character.hpMax}
            </div>
          </div>
          <div style={{ textAlign: 'center' }}>
            <div className="label" style={{ marginBottom: 4 }}>CA</div>
            <div style={{ fontFamily: 'var(--font-body)', fontSize: '1.4rem', fontWeight: 700, color: 'var(--gold)', lineHeight: 1 }}>
              {sheet.armorClass ?? '—'}
            </div>
          </div>
          <div style={{ textAlign: 'center' }}>
        ...
        <div className="hp-bar-track">
          <div className="hp-bar-fill" style={{ width: `${hpPct}%`, background: hpFillColor, boxShadow: 'none' }} />
        </div>
      </div>
    </a>
  );
